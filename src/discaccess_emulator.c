...
void discaccess_emulator_init( uint8_t instance , uint8_t address)
{
   ...
   Pi1MHz_Register_Memory(WRITE_FRED, (ram_address+0u), discaccess_emulator_byte_addr );
   Pi1MHz_Register_Memory(WRITE_FRED, (ram_address+1u), discaccess_emulator_byte_addr );
   Pi1MHz_Register_Memory(WRITE_FRED, (ram_address+2u), discaccess_emulator_byte_addr );
   // data byte
   Pi1MHz_Register_Memory(WRITE_FRED, (ram_address+3u), discaccess_emulator_byte_write_inc );
   Pi1MHz_Register_Memory(READ_FRED , (ram_address+3u), discaccess_emulator_byte_read_inc );
   // command pointer
   Pi1MHz_Register_Memory(WRITE_FRED, (ram_address+4u), discaccess_emulator_command );
