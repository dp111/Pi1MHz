...
/* Nudge the video plane on the Beeb's raster: x in Beeb MODE 0 pixels
   (positive = right), y in Beeb rows (positive = down).  Applied at plane
   creation and, if the plane exists, at the next blanking. */
