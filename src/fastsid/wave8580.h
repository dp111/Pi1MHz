...
/* Pi1MHz: only referenced when FASTSID_COMBINED_WAVEFORMS is 1 (see
 * fastsid.c). Left in place, compiled out, so upstream pulls still diff. */
...
#endif /* FASTSID_COMBINED_WAVEFORMS */
