...
# chroma gain suitable to south disc
ld-decode/tools/ld-chroma-decoder/ld-chroma-decoder --decoder transform3d -p y4m -s $i -l 1  --chroma-gain 1.18 -q "$tbc_file"  | ffmpeg -hide_banner -loglevel error -i - -flags +ilme+ildct -pix_fmt yuv422p -color_primaries bt470bg -color_trc bt709 -colorspace bt470bg -color_range tv -vf setdar=4/3,setfield=tff,scale=768x576 -c:v rawvideo "frame$divided_i.yuv"
