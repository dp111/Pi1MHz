...
| `LDVideoXoffset` | integer | -768 … 768 | Horizontal alignment of the Domesday video on the Beeb's picture, in Beeb MODE 0 pixels (1/640 of the line); positive moves the video right. Absent = `-4`. |
